            ...
            if "For your security, approve the notification sent to:" in driver.page_source:
                ...
                if "LWAFragment" in driver.page_source:
                    ...
                    try:
                        ...
                        el=WebDriverWait(driver, 100).until(lambda driver: driver.find_element(By.XPATH, value='//*[@id="SuggestedAddress"]/div[2]/div[1]/div/div[3]/div[2]/div/div/div/input'))
                        ...
                        Submit = WebDriverWait(driver, 20).until(
                            ...
                            driver.find_element(
                                by=By.XPATH,
                                value='/html/body/div[1]/div[2]/div[1]/div/div[5]/div[3]/div[2]/div/div[2]/div/div[3]/div[2]/div[5]/div/span[1]/span/input'))
                        driver.execute_script("arguments[0].scrollIntoView();", Submit)
                        sleep(0.3)
